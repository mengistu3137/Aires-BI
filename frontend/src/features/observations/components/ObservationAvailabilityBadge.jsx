...
import { getAvailabilityBadgeLabel, getAvailabilityColors } from "../utils/observation.utils.js";

export const ObservationAvailabilityBadge = ({ availability }) => {
  if (!availability) {
    return (
  ...
  const colors = getAvailabilityColors(availability);
  ...
  return (
    ...
    >
      ...
      {getAvailabilityBadgeLabel(availability)}
    </span>
  );
};
