 ...
 *    Management Users (Admin & Manager) → Competitors → Stores
 *      → 120 Products + Benchmark Prices → Open Survey Period
 *
 *  - Users: Administrator and Pricing Manager ONLY
 *  - Field Agents / Assignments / Audits: 0 rows (dispatched by Manager via UI)
 *  - Observations / Analyses / Alerts: 0 rows (generated by live operations)
...
async function main() {
  ...
  // 1. Management Users ONLY (Admin & Pricing Manager)
  ...
  console.log(`✅ Seeded ${users.length} Management Users (Admin & Manager)`);
  ...
  // 6. Zero Operational Data Policy
  console.log(
    "🛡️  [PRODUCTION POLICY] Assignments, Audits, Observations, Analyses, and Alerts: 0 rows seeded.\n" +
    "    Auditors can be registered and assigned dynamically through the platform UI."
  );

  // ==========================================================
  // SUMMARY
  // ==========================================================
  console.log("\n🎉 [Aires-BI] Clean production initialization complete!\n");
  console.log("════════════════════════════════════════════════════════");
  console.log(" MANAGEMENT CREDENTIALS");
  console.log(
    ` Password: ${process.env.SEED_DEFAULT_PASSWORD || "Aires@2026"}`
  );
  console.log("════════════════════════════════════════════════════════");
