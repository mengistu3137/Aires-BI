...
export const createAssignmentSchema = z.object({
    ...
    items: z.array(z.string()).min(1, "At least one product item must be assigned"),
...
export const batchSyncSchema = z.object({
    entries: z.array(submitEntrySchema).min(1, "At least one survey entry required for batch sync"),
});